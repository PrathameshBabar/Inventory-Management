    ...
    if (isset($_GET['e_id'])) {
        ...
        if (!mysqli_stmt_prepare($stmt, $sql)) {
            ...
            if ($row = mysqli_fetch_assoc($result)) {
                ...
                $date = $row['date'];
                $quantity = substr($row['quantity'],1);
            }
            else{
                header("Location: production.php");
            }
                        ...
                        <div class="col-md-12">
                            <div class="card shadow mb-4">
                                ...
                                <div
                                    ...
                                    <h6 class="m-0 font-weight-bold text-primary">Edit Dispatch</h6>
                                </div>
                                <!-- Card Body -->
                                <div class="card-body">
                                    <form action="dispatch.php" method="post">
                                        <div class="form-group">
                                            ...
                                            <input type="submit" class="btn btn-primary btn-user btn-block" value="UPDATE DISPATCH">
                                            <br>
                                        </div>
                                    </form>
                                </div>
